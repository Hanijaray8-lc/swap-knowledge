...
const ApprovalPage = () => {
  ...
  const fetchRequests = async () => {
    setLoading(true);
    try {
      const response = await fetch("https://swap-knowledge.onrender.com/api/permissions/requests");
  ...
  const handleAction = async (requestId, action) => {
    try {
      ...
      const response = await fetch(`https://swap-knowledge.onrender.com/api/permissions/requests/${requestId}`, {
        method: 'PUT',
        headers: {
  ...
  const sendPaymentInstructions = async () => {
    try {
      ...
      const response = await fetch(`https://swap-knowledge.onrender.com/api/permissions/requests/${request._id}/payment-message`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
