...
export default function MyPosts() {
  ...
  const fetchPosts = async () => {
    ...
    try {
      ...
      const postsResponse = await axios.get(`https://swap-knowledge.onrender.com/api/posts/staff/${staffId}`);
  ...
  const fetchPostCount = async () => {
    ...
    try {
      const countResponse = await axios.get(`https://swap-knowledge.onrender.com/api/posts/count/staff/${staffId}`);
  ...
  const handleDeletePost = async (postId) => {
    ...
    try {
      await axios.delete(`https://swap-knowledge.onrender.com/api/posts/${postId}`);
      fetchPosts();
    } catch (err) {
