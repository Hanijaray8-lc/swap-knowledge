...
const SendMessagePage = () => {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      try {
        const res = await axios.get(`https://swap-knowledge.onrender.com/api/messages/${selectedStudentName}`);
  ...
  try {
    const res = await axios.post('https://swap-knowledge.onrender.com/api/messages/send', newMsg);
