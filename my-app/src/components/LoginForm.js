...
export default function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://swap-knowledge.onrender.com/api/swapKnowledge/login', {
        email,
        password,
      });
  ...
  const handleResetSubmit = async () => {
    try {
      const response = await axios.post(
        'https://swap-knowledge.onrender.com/api/swapKnowledge/reset-password',
        resetForm
      );
