    ...
    const fetchMeetingDetails = async () => {
      try {
        ...
        const response = await axios.get(
          `https://swap-knowledge.onrender.com/api/meetings/student/${encodeURIComponent(studentName)}`
        );
        ...
        if (response.data && response.data.meetLink) {
          ...
          const timeResponse = await axios.get(
            `https://swap-knowledge.onrender.com/api/meetings/check-time/${encodeURIComponent(studentName)}`
          );
