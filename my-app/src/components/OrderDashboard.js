...
const AdminUserDashboard = () => {
  ...
  const fetchPendingRequests = async () => {
    try {
      const token = localStorage.getItem('authToken');
      const response = await fetch('https://swap-knowledge.onrender.com/api/admin/pending-requests', {
        headers: {
  ...
  const loadAdminRequestCounts = async (adminsList) => {
    ...
    for (const admin of adminsList) {
      try {
        const response = await fetch(`https://swap-knowledge.onrender.com/api/admin/admin-requests-count/${admin._id}`);
  ...
  const handleSendRequest = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://swap-knowledge.onrender.com/api/admin/send-request/${requestDialog.admin._id}`, {
        method: 'POST',
        headers: {
  ...
  const fetchStaffRequests = async (adminId) => {
    ...
    try {
      const response = await fetch(`https://swap-knowledge.onrender.com/api/admin/admin-requests/${adminId}`);
      const data = await response.json();
  ...
  const handleRequestAction = async (requestId, status) => {
    try {
      const response = await fetch(`https://swap-knowledge.onrender.com/api/admin/update-request/${requestId}`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const fetchAllRequests = async () => {
    try {
      const response = await fetch('https://swap-knowledge.onrender.com/api/admin/requests');
      return await response.json();
    } catch (error) {
  ...
  const approveRequest = async (requestId) => {
    try {
      const response = await fetch(`https://swap-knowledge.onrender.com/api/admin/requests/${requestId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
...
const fetchAdmins = async () => {
  try {
    const response = await fetch('https://swap-knowledge.onrender.com/api/admin/admins');
    const data = await response.json();
    return data;
  } catch (error) {
