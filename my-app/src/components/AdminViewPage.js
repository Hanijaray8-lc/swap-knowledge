...
const AdminViewPage = () => {
  ...
  useEffect(() => {
    const fetchAdmin = async () => {
      try {
        const token = localStorage.getItem('token');
        const res = await fetch(`https://swap-knowledge.onrender.com/api/admin/admins/${id}`, {
        ...
        const pendingRes = await fetch(
          `https://swap-knowledge.onrender.com/api/admin/pending-requests/${data.fullName}/${data.department}`
        );
  ...
  const fetchFollowers = async (adminId) => {
    ...
    try {
      const res = await fetch(`https://swap-knowledge.onrender.com/api/follow/followers/${adminId}`);
      const data = await res.json();
  ...
  const fetchCapacityInfo = async (adminId) => {
    try {
      const res = await fetch(`https://swap-knowledge.onrender.com/api/permissions/staff-capacity/${adminId}`);
      const data = await res.json();
  ...
  const fetchPendingPermissions = async (adminId) => {
    ...
    try {
      const res = await fetch(`https://swap-knowledge.onrender.com/api/permissions/requests`);
      const data = await res.json();
  ...
  const fetchStaffPosts = async () => {
    ...
    setPostsError(null);
    try {
      const res = await fetch(`https://swap-knowledge.onrender.com/api/posts?staffName=${encodeURIComponent(admin.fullName)}`);
      const data = await res.json();
  ...
  const handlePaymentSuccess = async (paymentData) => {
    try {
      const response = await fetch(`https://swap-knowledge.onrender.com/api/permissions/requests/${selectedPermission._id}/payment`, {
        method: 'PUT',
        headers: {
  ...
  const handleSendRequest = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://swap-knowledge.onrender.com/api/permissions/send-request/${admin._id}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
